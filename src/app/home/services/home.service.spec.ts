...
describe('HomeService', () => {
  ...
  it('should run #getNowshowing()', async () => {
   ...
   let upcomingMoviesUrl = BASE_URL.TMDB_API + TMDB_URLS.UPCOMING_MOVIES + environment.API_KEY + '&page=';
    ...
    req.flush(movies);
  const getCreditsUrl =
    BASE_URL.TMDB_API + TMDB_URLS.GET_CREDITS + 1 + '/credits?' + environment.API_KEY;
    const req2 = httpTestingController.expectOne(getCreditsUrl);

    expect(req2.request.method).toBe('GET');
    let credits = { cast: ['case1','case1','case1','case1'],
crew: ['case1','case1','case1','case1']};
    req2.flush(credits);
  });
